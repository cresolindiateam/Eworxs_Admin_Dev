...
$sqlUniqueEmail="SELECT id FROM companies WHERE email = '$email'";
...
$sqlInsert = "INSERT INTO companies(company_name,first_name,last_name,email,phone,password,postal_code,created_at,status,logo,role)"." VALUES('$company_name','$first_name','$last_name','$email','$phone','$password','$postal_code',now(),$status_data,'$file',2)";
	...
	if(!empty($last_id)){
		...
		$message="Company did not Created.";
	}
}
$db->close(); 
