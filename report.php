...
/*$sql = "SELECT id,company_id,first_name,last_name,email,phone,password,local_address,permanent_address,postal_code,status,created_at,work_rate,mileage_rate FROM workers where company_id = $company_id ORDER BY id";*/
  ...
  foreach ($data as $key => $value){
    ...
    $data[$key]['return_mileage']= $value['return_mileage'];
  }
?>
<!DOCTYPE html>
<html>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="make-inline"><!-- Worker's Pay Analysis -->Worker Pay Data</h1>
      <a href="report_csv.php"><button class="btn btn-warning pull-right">Export&nbsp;&nbsp;<i class="fa fa-file-excel-o"></i></button></a>
