                ...
                if ($sub_id_value != "" && $radioVal != "") {
                    ...
                    if ($result1734 != "") {
                       ...
                       /* echo $sql;
                        ...
                        $sql2223 = "update companies  set checkoutsession_id ='' WHERE id='$company_id' ";
                       /* echo $sql;
                        die();*/
                        $db->query($sql2223);
                ...
                if ($data7777 != "") 
                {
                    ...
                    if ($result1796 != "") 
                    {
                        ...
                        $db->query($sql1111);
                          ...
                          $sql1112 = "update companies  set checkoutsession_id ='' WHERE id='$company_id' ";
                        $db->query($sql1112);
...
<?php foreach ($data as $key => $item) {
    ...
    echo "<td>" . $item["amount"] . "</td>";
     ...
     echo "<td>" . $item["amount"]*$item["num_emp"] . "</td>";
    if ($item["type"] == 1) {
        echo "<td>Monthly</td>";
    } elseif ($item["type"] == 2) {
        echo "<td>Yearly</td>";
